...
const status = [
  ...
  { name: "Simulación epidemiológica (SEIR)", done: false },
  { name: "Agente de recomendación & IA Generativa", done: false },
];
...
const tech = [
  ...
  { ic: "cpu", title: "Modelos de IA", desc: "TensorFlow, Scikit-Learn" },
];
